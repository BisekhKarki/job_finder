...
const JobUpdateForm = () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            experienceLevel: jobData?.experience_level || "entry",
            location: jobData?.location || "",
            salaryMin: jobData?.salary_min ? String(jobData.salary_min) : "",
            salaryMax: jobData?.salary_max ? String(jobData.salary_max) : "",
            tags: jobData?.tags || [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${baseurl}/api/jobs/${slug}/update/`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${accessToken}`,
        ...
        {formData.title && (
          <div className="mt-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              {formData && formData.tags.length > 0 && (
                <div className="mb-6">
