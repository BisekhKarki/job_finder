...
export default function CreateCompanyProfile() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${baseurl}/api/jobs/company/create/`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        toast.error(val.errors.message, {
          position: "bottom-right",
        });
      }
    } catch (error) {
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 py-10 pb-24">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Tell us about your company. You can update these details anytime.
          </p>
        </div>
